...
SQLModel metadata so autogenerate sees all our models.
"""
...
# Inject our DB URL into Alembic's config so alembic.ini stays generic.
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        render_as_batch=True,  # SQLite: emit ALTER via batch operations
    )
